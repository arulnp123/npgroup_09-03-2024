...
if (isset($_POST['submit'])) {
    ...
    $state = trim($_POST['state']);
	 ...
	 $about = trim($_POST['about']);
        ...
        $stmt = $conn->prepare("INSERT INTO form (fname,email,phone,address,city,state,about) VALUES (?,?,?,?,?,?,?)");

        $stmt->bind_param("sssssss", $fname,$email,$phone,$address,$city,$state,$about);
