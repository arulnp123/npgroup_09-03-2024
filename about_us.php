...
<!-- Bootstrap -->
<link rel="icon" href="images/1.jpg" type="images/NPG.jpg" sizes="16x16">
  ...
  <div class="space-bottom-80">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-sm-6">
          <h1>ABOUT COMPANY</h1>
          <p>NP Software Service has expertise in developing software solutions such as the following areas,	
		  Highly secured web-based applications, Mobile applications, Implementation of Web Services, Search Engine Optimization (SEO) ,	
		  HTTP tunneling AJAX, JSON.

</p>

      <p>Web Application Development and Maintenance is a part of our Core activity. We providing clients innovative solutions to 
	  their software needs using PHP 5, ASP, .NET, JSP, J2EE, Java, Voice XML, XML-HTTP Messaging and AJAX technologies with MySQL, 
	  MS SQL, Oracle and MS ACCESS as databse. We handle new or existing system with front and back-office applications.We also Provide 
