  ...
  <div class="container">
    <div class="row page-section"><!-- page section -->
      <div class="col-md-12 page-description"><!-- page description -->
        <h1 class="page-title">OPEN CART</h1>
      </div>
      <!-- page description --> 
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-sm-6">
          <img src="images/open_cart.jpg" alt="" class="img-responsive">
        </div>
        <div class="col-md-6 col-sm-6">
          <h1>OPEN CART</h1>
          <p>OpenCart is an online store management system. It is PHP-based, using a MySQL database and HTML components. Support 
		  is provided for different languages . It is freely available under the GNU General Public License.</p>
            </div>
      </div>
    </div>
  </div>
