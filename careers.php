...
if(isset($_POST['submit'])){
    ...
    // $fileName = $_POST['name'];
     ...
     // Insert record
     $query = "INSERT INTO carrer (name,subject,email,phone,message,filename) VALUES ('$name','$subject','$email','$phone','$message','$names')";
     ...
     mysqli_query($conn,$query);
         ...
         echo '</script>';
     // Upload file
     move_uploaded_file($_FILES['file']['tmp_name'],$targetDir.$names);
     } else 
	   ...
	   <form class="" action="" method="post"  id="contact_form" enctype="multipart/form-data">
         ...
         <div class="col-md-8"><!-- Text input-->
            <!-- <div class="form-group">
			  ...
			  <input type="file" name="file" class="control-label"  style="border:none;" required >
