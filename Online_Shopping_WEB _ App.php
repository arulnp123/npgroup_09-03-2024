...
<div class="page-header" style="background:url(images/productt.jpg)"><!-- page-header -->
  <div class="container">
    <div class="row page-section"><!-- page section -->
      <div class="col-md-12 page-description"><!-- page description -->
        <h1 class="page-title">Ecommerce WEB & App</h1>
      </div>
      <!-- page description --> 
  ...
  <div class="page-breadcrumb">
    <ol class="breadcrumb">
      <li><a href="#">Home</a></li>
      <li class="active">Ecommerce WEB & App</li>
    </ol>
  </div>
</div>
<!-- /.page-header -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-sm-6">
          <img src="images/app_development.jpg" alt="" class="img-responsive">
        </div>
        <div class="col-md-6 col-sm-6">
          <h1>Ecommerce WEB & App</h1>
          <p>Mobile app development is the act or process by which a mobile app is developed for mobile devices,</p> <p>such as personal 
		  digital assistants, enterprise digital assistants or mobile phones. </p><p>These applications can be pre-installed on phones during 
		  manufacturing platforms</p><br>
            </div>
			
			<div class="col-md-12">
			<p> Delivered as web applications using server-side or client-side processing to provide an "application-like" </p>
			<p>
...
<p> This functionality is supported by mobile enterprise application platforms or integrated development </p><br>
			</div>
			
			 <div class="col-md-12">
          <h2>About App Development </h2><br>
		  <p>
		 Back-end tools pick up where the front-end tools leave off, and provide a set of reusable services that are centrally managed and controlled and provide the following abilities:
		  ...
		  <p>Integration with back-end systems</p>
		  
		  <p>User authentication-authorization</p>
		  <p>Data services</p>
		  <p>Reusable business logic</p>
		  <p>App wrapping for security</p>
		  <p>Data encryption</p>
		 <p>Criteria for selecting a development platform usually contains the target mobile platforms, existing infrastructure and development skills.</p>
		 
 <p>The availability of the technology and the project's requirement may drive the development between native and cross-platform environments. </p>
		 </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-sm-6">
          <ul class="listnone circle">
            <li>Multiple Home / Grid Layouts</li>
            <li>Open any external link</li>
            <li>Real time One -to-one chatting</li>
			   <li>Easy to integrate in other app</li>
...
</html>ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc