...
if(isset($_POST['submit']))
{
  ...
  <strong>Error!</strong> Please fill required fields
	...
	if(empty($status))
	{
         ...
         $header = "From:abiya@npgroups.com   \r\n";
...
<script type="text/javascript" src="https://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=PtjHnzcIe87brTolXgnWsjuYgZdcIXZzs_Woo5US6NqOwWiBZQzrImZUo-By2icqmDWAWM00Gz2GrHDKHzPSsqnM0O-eZoV0FeYpIkqGRIKZ_1zYORuk6ec8Wje9E0k5VG6h8n2tW3QQx2e4s_7fANoHbfUo42Isrocb-CdsH4wMpDVNuvcwqeu18TjKXdmCbD54LOiZ9_SAdeueAcUu18skreU5KoSazvTyjb8eYrBIyeMPqPdf6rBa6tVkMFn9Vzw7CpWVSxbRcNfb_ayIn4wbKLauY_HpxMsfciNgGaQ" charset="UTF-8"></script></head>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                           <!-- <form class="contact-form" id="contactus" method="post" action="">-->
                                  <form class="contact-form" action="send_form_email.php " method="post"  id="contact_form">
				
	 <form id="sign_up" method="POST"  class="col s12" enctype="multipart/form-data">	
                                <div class="row">
                                    <!-- Text input-->
                                    <div class="col-md-9">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <label class="control-label" for="subject">Phone</label>
                ...
                <div class="col-md-offset-1 col-md-4 sidebar col-sm-12">
                    ...
                    <div class="row">
                     ...
                     35/196A, Rajam kannan Building,  <br>
                     Santhanchettivilai
                      Nagercoil-629 001.
