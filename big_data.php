    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-sm-6">
          <img src="images/big_data.jpg" alt="" class="img-responsive">
        </div>
        <div class="col-md-6 col-sm-6">
          <h1>BIG DATA</h1>
          <p>Big data is a term used to refer to the study and applications of data sets that are too complex for traditional data-processing 
		  application software to adequately deal with. Big data challenges include capturing data, data storage, data analysis, search, sharing, 
		  transfer, visualization, querying, updating, information privacy and data source Modern usage of the term "big data" tends to refer to 
		  ...
		  and seldom to a particular size of data set. "There is little doubt that the quantities of data now available are indeed large, but that’s 
		  not the most relevant characteristic of this new data ecosystem.</p>
            </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-sm-6">
          <ul class="listnone circle">
            <li>Embeddable results</li>
            <li>Data wrangling</li>
            <li>Data exploration</li>
			   <li>Support for different analytics</li>
			     <li>Scalability</li>
          </ul>
        </div>
        <div class="col-md-6 col-sm-6">
